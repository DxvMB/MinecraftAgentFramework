...
class TestChatBotAgent(unittest.TestCase):
    ...
    @patch("MinecraftAgentFramework.agents.chat_bot.ChatBot.query_llm", return_value="Hi!")
    ...
    @patch("MinecraftAgentFramework.agents.chat_bot.ChatBot.read_minecraft_chat", return_value=("Hello", 1))
    @patch("MinecraftAgentFramework.agents.chat_bot.ChatBot.query_llm", return_value="Hi!")
